...
transStmt x = case x of
  ...
  Jezyk.Abs.SIfte bexpr stmt1 stmt2 -> failure x
  Jezyk.Abs.SIfend bexpr stmt -> failure x
  Jezyk.Abs.SWhile bexpr stmt -> failure x
...
transBExpr :: Jezyk.Abs.BExpr -> Result
transBExpr x = case x of
  Jezyk.Abs.BAnd bexpr1 bexpr2 -> failure x
  Jezyk.Abs.BOr bexpr1 bexpr2 -> failure x
  Jezyk.Abs.BNot bexpr -> failure x
  Jezyk.Abs.BEq expr1 expr2 -> failure x
  Jezyk.Abs.BLt expr1 expr2 -> failure x
  Jezyk.Abs.BLeq expr1 expr2 -> failure x
  Jezyk.Abs.BGt expr1 expr2 -> failure x
  Jezyk.Abs.BGeq expr1 expr2 -> failure x
  Jezyk.Abs.BNeq expr1 expr2 -> failure x
  Jezyk.Abs.BTrue -> failure x
  Jezyk.Abs.BFalse -> failure x
  Jezyk.Abs.BCheck expr ident -> failure x
